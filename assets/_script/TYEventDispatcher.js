...
exports.TYEventDispatcher = exports._TYEventDispatcher = undefined;
var r_TYEvent = require("TYEvent");
var exp__TYEventDispatcher = function () {
  function _ctor() {
  ...
  _ctor.prototype.dispatchEventWith = function (e, t) {
    if (this.hasEventListener(e)) {
      var o = r_TYEvent.TYEvent.create(r_TYEvent.TYEvent, e);
      o.data = t;
      this.dispatchEvent(o);
      r_TYEvent.TYEvent.release(o);
    }
    return true;
  };
...
exports._TYEventDispatcher = exp__TYEventDispatcher;
exports.TYEventDispatcher = new exp__TYEventDispatcher();