...
var def_CommerceResultUI = function (e) {
  function _ctor() {
    return e.call(this, r_UIDef.UIDef.Pack.Bartender, r_UIDef.UIDef.Res.UI.CommerceResultUI) || this;
  }
  __extends(_ctor, e);
  _ctor.showUI = function (e, t) {
    this.show(r_UIDef.UIDef.Urls.UI.CommerceResultUI, e, t);
  };
  _ctor.hide = function () {
    e.hide.call(this, r_UIDef.UIDef.Urls.UI.CommerceResultUI);
  };
  ...
  _ctor.prototype.onClickGet = function () {
    if (this.data.earn >= 0) {
      r_PlayerData.PlayerData.addCoin("调配饮品", this.data.earn, r_ReportSystem.SystemKey.小游戏);
    } else {
      if (!r_PlayerData.PlayerData.isCoinEnough(Math.abs(this.data.earn))) {
        r_PlayerData.PlayerData.deleteCoin("调配饮品", r_PlayerData.PlayerData.bigCoin, r_ReportSystem.SystemKey.小游戏);
        return void this.hide();
      }
      r_PlayerData.PlayerData.deleteCoin("调配饮品", Math.abs(this.data.earn), r_ReportSystem.SystemKey.小游戏);
    }
    this.hide();
  };
  _ctor.prototype.onClickDouble = function () {
    var e = this;
    r_PlatformSystem.PlatformSystem.showVideo("调配饮品双倍", function () {
      r_PlayerData.PlayerData.addCoin("调配饮品双倍", 2 * e.data.earn, r_ReportSystem.SystemKey.小游戏);
      e.hide();
    });
  };
  _ctor.prototype.onClickMainchu = function () {
    var e = this;
    r_PlatformSystem.PlatformSystem.showVideo("奶茶免除惩罚", function () {
      e.hide();
    });
  };
  _ctor.prototype.restart = function () {
    ...
    this.imgicon.url = "ui/commerce/" + this.data.name;
...
exports.default = def_CommerceResultUI;