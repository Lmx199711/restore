...
var def_NewHomeWayChatUI = function (e) {
  function _ctor() {
    var t = e.call(this, r_UIDef.UIDef.Pack.NewGuide, r_UIDef.UIDef.Res.UI.NewHomeWayChatUI) || this;
    t.showAnimFlag = true;
    t.m_step = 0;
    t.m_maxStep = 4;
    return t;
  ...
  _ctor.showUI = function (e, t) {
    this.show(r_UIDef.UIDef.Urls.UI.NewHomeWayChatUI, e, t);
  };
  _ctor.hide = function () {
    e.hide.call(this, r_UIDef.UIDef.Urls.UI.NewHomeWayChatUI);
  };
  ...
  _ctor.prototype.onClickbtnBack = function () {
    ...
    r_PlayerData.PlayerData.data.homeWayMap.reward = true;
  };
...
exports.default = def_NewHomeWayChatUI;