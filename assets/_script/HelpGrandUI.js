...
var exp_HelpGrandUI = function (e) {
  function _ctor() {
    var t = e.call(this, r_UIDef.UIDef.Pack.Lamp, r_UIDef.UIDef.Res.UI.HelpGrandUI) || this;
    t.uiType = "fullScreen";
    return t;
  }
  __extends(_ctor, e);
  _ctor.showUI = function (e, t) {
    this.show(r_UIDef.UIDef.Urls.UI.HelpGrandUI, e, t);
  };
  _ctor.hide = function () {
    e.hide.call(this, r_UIDef.UIDef.Urls.UI.HelpGrandUI);
  };
  ...
  _ctor.prototype.onShown = function () {
    ...
    r_SoundMgr.SoundMgr.playMusic("helpGrand/jiujiubgm");
    r_RelaxLevelLogicSystem.RelaxLevelLogicSystem.clearLevel();
    r_ResSystem.ResSystem.loadBundleRes("game2", "helpGrand/帮助爷奶", cc.Prefab, function (e, o) {
      if (!e) {
...
exports.HelpGrandUI = exp_HelpGrandUI;