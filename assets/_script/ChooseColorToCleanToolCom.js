...
exports.ChooseColorToCleanToolCom = undefined;
...
var f = function () {
  ...
  return __decorate([_ccclass("ChooseColorNodeInfo")], e);
}();
var exp_ChooseColorToCleanToolCom = function (e) {
  function _ctor() {
  ...
  return __decorate([_ccclass, y(r_OperationToolCom.OperationToolCom), _menu("新系统/工具/特定的清理/先选择颜色之后,才能清理,按照顺序,一一对应")], _ctor);
}(r_ToolComBase.ToolComBase);
exports.ChooseColorToCleanToolCom = exp_ChooseColorToCleanToolCom;