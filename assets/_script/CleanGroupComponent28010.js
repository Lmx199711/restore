...
var def_CleanGroupComponent28010 = function (e) {
  function _ctor() {
  ...
  _ctor.prototype.touchStart = function (e) {
    if (this.canTouchMask && cc.isValid(this.node)) {
      var t = e.touch.getLocation();
      this.checkTouch(t);
      "" != this.res && r_SoundMgr.SoundMgr.playSound(this.res, true);
    }
  };
  ...
  _ctor.prototype.touchEnd = function () {
    this.cleanEnd();
    "" != this.res && r_SoundMgr.SoundMgr.stopSound(this.res);
  };
  ...
  _ctor.prototype.checkTouch = function (e) {
    ...
    if (this.curState == s.Clean) {
      ...
      this.lastCleanWorldPoint || (this.lastCleanWorldPoint = t);
      this.cleanPoint(t);
  ...
  _ctor.prototype.fillAll = function () {
    for (var e = 0; e < this.maskList.length; e++) {
      ...
      t._graphics.rect(-2e3, -2e3, 4e3, 4e3);
      t._graphics.fill();
      t._graphics.stroke();
    }
  };
  _ctor.prototype.reset = function () {
    var e;
    for (var t = 0; t < this.maskList.length; t++) {
      null === (e = this.maskList[t]._graphics) || undefined === e || e.clear();
    }
  };
  ...
  __decorate([_property({
    displayName: "音效路径",
    tooltip: "音效路径"
  })], _ctor.prototype, "res", undefined);
  return __decorate([_ccclass], _ctor);
}(cc.Component);
exports.default = def_CleanGroupComponent28010;