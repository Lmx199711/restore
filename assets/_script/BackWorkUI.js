...
var r_BackWorkLogic = require("BackWorkLogic");
var r_FguiResSystem = require("FguiResSystem");
var exp_BackWorkUI = function (e) {
  function _ctor() {
    return e.call(this, r_UIDef.UIDef.Pack.Lamp, r_UIDef.UIDef.Res.UI.BackWorkUI) || this;
  }
  var _ref__ctor;
  __extends(_ctor, e);
  _ref__ctor = _ctor;
  _ctor.showUI = function (e, t) {
    this.show(r_UIDef.UIDef.Urls.UI.BackWorkUI, e, t);
  };
  _ctor.hide = function () {
    e.hide.call(this, r_UIDef.UIDef.Urls.UI.BackWorkUI);
  };
  ...
  _ctor.prototype.onShown = function () {
    ...
    r_ResSystem.ResSystem.loadBundleRes("game1", "backWork/春节返工", cc.Prefab, function (e, o) {
          ...
          switch (e.label) {
            case 0:
              if (o) {
                ...
                this.gameLogic = this.prefab.getComponent(r_BackWorkLogic.default);
  ...
  _ctor.prototype.againStartGame = function () {
    var e = this;
    r_RelaxLevelLogicSystem.RelaxLevelLogicSystem.clearLevel();
    r_ResSystem.ResSystem.loadBundleRes("game1", "backWork/春节返工", cc.Prefab, function (t, o) {
...
exports.BackWorkUI = exp_BackWorkUI;