...
var def_BitLimitRule = function () {
  ...
  _ctor.prototype.checkLimit = function (e, t, o) {
    ...
    return !(e.x > a.width / 2 - this.m_minDis || e.x < -(a.width / 2 - this.m_minDis) || e.y + this.m_node.height / 2 > 0 || e.y - this.m_node.height / 2 < -(a.height - this.m_minDis) || -1 != this.m_mapBottom.children.findIndex(function (e) {
      var a = cc.v2();
...
exports.default = def_BitLimitRule;