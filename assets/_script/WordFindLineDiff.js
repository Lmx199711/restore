...
var v = function () {
  ...
  return __decorate([_ccclass("WordFindLineDiffInfo")], e);
}();
var def_WordFindLineDiff = function (e) {
  function _ctor() {
  ...
  _ctor.prototype.showAnwser = function () {
    for (var e = 0; e < this.itemLists.length; e++) {
      ...
      t.node.active = true;
      if (!t.isFinish) {
        t.tipNode.active = true;
        t.tipNode.color = cc.Color.GREEN;
      }
    }
  };
  ...
  return __decorate([_ccclass, _menu("文字游戏/线稿找茬")], _ctor);
}(r_LevelPreload.default);
exports.default = def_WordFindLineDiff;